...
app.use(helmet({
  contentSecurityPolicy: { // Use a strict CSP to prevent XSS attacks, this helps mitigate risks from malicious scripts by restricting sources of content
    directives: {
      defaultSrc: ["'self'"], // Default source is self to prevent loading resources from other origins
      styleSrc: ["'self'", "https://cdn.jsdelivr.net", "https://stackpath.bootstrapcdn.com", "https://cdn.jsdelivr.net", "https://stackpath.bootstrapcdn.com", "https://fonts.googleapis.com", "https://use.fontawesome.com"], // Allow styles from trusted CDNs and self
      fontSrc: ["'self'", "https://cdnjs.cloudflare.com", "https://fonts.gstatic.com", "https://use.fontawesome.com"], // Allow fonts from trusted sources
